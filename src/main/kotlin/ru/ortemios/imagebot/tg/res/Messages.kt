...
class Messages {
    companion object {
        ...
        const val GENERAL_ERROR = "Неизвестная ошибка..."
        const val INCORRECT_SYNTAX = "Некорректный синтаксис, проверьте значения и количество аргументов."

        const val GROUP_SET = "Группа установлена."
        const val GROUP_NOT_SET_ERROR = "Группа для публикации не установлена. " +
                "Пригласите бота в нужную группу, используя команду `${Commands.setGroup} <group_id>`."
